...
export default function RakshatechHeader() {
  return (
    <div className="flex flex-col min-h-[30vh] md:min-h-[35vh] w-full justify-between items-center px-4 pt-6 md:pt-8 lg:pt-10 pb-8 md:pb-12 lg:pb-16">
      {/* Title Section */}
      ...
      {/* Register Button */}
      <button className="bg-[#007A58] text-white py-2 px-6 md:py-3 md:px-8 lg:py-4 lg:px-12 mt-6 md:mt-8 rounded-[20px] shadow-lg font-text transition-transform hover:scale-105">
        Register now
      </button>
    </div>
  );
