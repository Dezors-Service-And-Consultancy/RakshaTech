...
const Navbar = () => {
  ...
  <div className="flex items-center justify-end space-x-8">
      ...
      {["About", "Schedule", "FAQ", "Sponsor", "Contact Us"].map((link) => (
        <li key={link}>
          <a
            ...
            className="px-2 py-1 md:px-4 md:py-2 lg:px-6 lg:py-3 rounded-md hover:bg-gradient-to-r from-[#36543df9] via-[#0c5636] to-[#0AAF56] active:bg-gradient-to-br from-[#02F6B3] to-[#007A58] transition duration-300"
          >
            {link}
          </a>
        </li>
    ...
    <a
      href="#login"
      className="px-4 py-2 rounded-[.5rem] border-2 border-[#007A58] bg-black text-[#007A58] hover:border-gradient-to-br hover:from-[#02F6B3] hover:to-[#007A58] transition duration-300"
    >
      Log in
    </a>
  ...
  {isOpen && (
    <ul className="absolute top-16 left-0 w-full bg-black text-white flex flex-col items-center space-y-4 p-4 lg:hidden">
      {["About", "Schedule", "FAQ", "Sponsor", "Contact Us"].map((link) => (
        <li key={link}>
          <a
            href={`#${link.toLowerCase()}`}
            className="px-4 py-2 rounded-md hover:bg-gradient-to-r from-[#36543df9] via-[#0c5636] to-[#0AAF56] active:bg-gradient-to-br from-[#02F6B3] to-[#007A58] transition duration-300"
          >
            {link}
          </a>
        </li>
