...
export default function RakshatechHeader(){
    return(
        <div className="flex flex-col h-[20vh] w-auto items-center justify-between items-center">
            <h1 className=" text-6xl font-quantico tracking-wide bg-gradient-to-b from-[#FFFFFF] via-[#FFFFFF] to-[#04362A] bg-clip-text text-transparent">
                Raksha Tech
            </h1>
