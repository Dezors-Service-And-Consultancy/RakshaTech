...
export default function Footer() {
  return (
    <>
        ...
        <div className="flex flex-col max-md:w-screen max-md:flex-row min-h-auto min-w-screen p-10 max-md:p-0 max-md:p-4">
          <div className="gap-10 flex flex-row md:flex-col max-md:gap-11 justify-between">
            ...
            <div className="mb-10 lg:text-right text-center flex flex-col mr-10">
              <h1 className="text-white font-quantico text-xl" itemProp="address" aria-label="Company Address">Address</h1>
              <h3 className="text-white font-thin max-md:text-nowrap" itemProp="addressLocality" aria-label="City">Chennai,</h3>
              <h3 className="text-white font-thin" itemProp="postalCode" aria-label="Postal Code">Tamil Nadu-600127</h3>
            </div>
          </div>
          <div className="flex flex-row md:flex-col justify-between">
            <div className="lg:text-right mb-10 flex flex-col text-center mr-10">
              <h1 className="text-white font-quantico text-xl" itemProp="email" aria-label="Company Email">Email</h1>
            ...
            <div className="lg:text-right flex flex-col text-center mr-10">
              <h1 className="text-white font-quantico text-xl" aria-label="Social Media Links">Social</h1>
      ...
      <h1 className="text-gray-100 text-3xl font-quantico font-extralight" aria-label="Contact Us Section">
        Contact Us

              Drop us a Line - We Value Your Feedback
            </h1>
          </div>
          <div className="h-[15rem] w-full pt-10 gap-10 pl-8 max-md:pl-0 pr-8 max-md:p-0">
            <div className="flex flex-col items-center gap-14 w-full p-4">
              <div className="flex w-full gap-4 max-md:flex-col">
                <input type="text" placeholder="Name" className="flex-1 bg-transparent border-b text-white focus:outline-none" />
                <input type="text" placeholder="Email" className="flex-1 bg-transparent border-b text-white focus:outline-none" />
                <input type="text" placeholder="Subject" className="flex-1 bg-transparent border-b text-white focus:outline-none" />
              </div>
              <input type="text" placeholder="Message" className="w-full flex-1 bg-transparent border-b text-white focus:outline-none" />
            </div>
          </div>
      ...
      <div className="relative bottom-0 w-full text-center py-2 border-t flex flex-col">
        <footer>
          <p className="text-green-500">
            All rights reserved @{" "}
            <a href="https://dezors.com" className="hover:underline">dezors.com</a>
          </p>
        </footer>
      </div>
    </>
