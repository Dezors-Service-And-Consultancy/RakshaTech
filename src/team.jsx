...
const App = () => {
  return (
    <div className="h-screen bg-[#0f1a0f] text-white flex">
      {/* Sidebar */}
      <div className="w-16 h-1/2 bg-green-500/20 backdrop-blur-md flex flex-col items-center justify-between py-4 space-y-2 rounded-full self-center">
        {/* Logo */}
        <img
          src=" " 
          alt="Logo"
      ...
      <div className="flex-1 flex flex-col p-6 relative">
        ...
        {/* Team Cards */}
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-20 shadow-lg h-screen">
